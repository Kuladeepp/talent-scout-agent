...
**Inputs:** three sample job descriptions in [`backend/tests/fixtures/sample_jds.json`](backend/tests/fixtures/sample_jds.json) (backend engineer, ML engineer, product designer).

**Output:** a complete captured `/scout` response is committed at [`docs/sample_outputs/backend_engineer_response.json`](docs/sample_outputs/backend_engineer_response.json) — 20 ranked candidates with match scores, interest scores, full conversation transcripts, matched/missing skills, and signal quotes. See [`docs/sample_outputs/README.md`](docs/sample_outputs/README.md) for a walkthrough of the response shape.

**Top result from the captured run:**

| JD | Top candidate | Match | Interest | Final |
|---|---|---|---|---|
| Backend Engineer (fintech, Bengaluru) | Aarav Sharma — Senior Backend Engineer | 93 | 68 | 83.0 |
| ML Engineer (LLM apps, remote) | (run live) | ~90+ | ~70+ | — |
| Senior Product Designer (B2B SaaS) | (run live) | ~85+ | ~65+ | — |
